# Generated by Django 4.2.11 on 2024-03-11 18:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(choices=[('otr', 'Other'), ('yt', 'YouTube'), ('ggl', 'Google'), ('nl', 'NewsLetter')], default='otr', max_length=5)),
                ('profile_picture', models.ImageField(blank=True, null=True, upload_to='')),
                ('special_file', models.FileField(blank=True, null=True, upload_to='')),
                ('agent', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='leads.agent')),
            ],
        ),
    ]
